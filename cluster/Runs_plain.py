exec(open("/home/zihanw8/scratch/dynamics_2020_07/Modules.py", encoding = 'utf-8').read())
...
inputFileName = '/home/zihanw8/scratch/dynamics_2020_07/input_'+'Nr='+sys.argv[1]+'_index='+sys.argv[2]+'D=10_balanced.pkl'
...
while new_ext_list != old_ext_list and count < 10:
    ...
    if count > Nr:
        cycled = True
        print('Could have been cycling') # paper scissor stone invasions
#print(survivors)
#print(output(system))
